const recommendationRequestFixtures = {
  oneRequest: {
    id: 0,
    requesterEmail: "test-requester-0",
    professorEmail: "test-professor-0",
  ...
  threeRequests: [
    {
      id: 1,
      requesterEmail: "test-requester-1",
      professorEmail: "test-professor-1",
    ...
    {
      id: 2,
      requesterEmail: "test-requester-2",
      professorEmail: "test-professor-2",
    ...
    {
      id: 3,
      requesterEmail: "test-requester-3",
      professorEmail: "test-professor-3",
